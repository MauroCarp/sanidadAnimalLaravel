...
<head>
  ...
  <title>Cronograma Vacunaci&oacute;n</title>
  <style type="text/css">
  ...
  * {
  ...
  .header-background {
    background: repeat-x url(img/logo.png) left bottom;
  }
...
<body bgcolor="#ffffff">
  <table class="alinear-tabla">
    <tr>
      <td>
        <img src="https://image.ibb.co/c24bES/logo.png" class="img-tamaño">
      </td>
    </tr>
  </table>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                                <p>Buenos dias, {{$data['vet']['nombre']}}. Se adjunta cronograma de vacunaci&oacute;n.</p>
                            </td>
                          </tr>
                        </table>
